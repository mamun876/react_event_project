                    ...
                    <div className="navbar-flex d-flex align-items-center justify-content-between w-100 pb-2 pt-2">
                        ...
                        <div className="navbar-collapse1 d-flex align-items-center" id="bs-example-navbar-collapse-1">
                            <ul className="nav navbar-nav" id="responsive-menu">
                                ...
                                <li><Link to='price' className="">Pricing</Link></li>
                                ...
                                <li className="search-main">
                                    <a href="#search1" className="mt_search"><i className="fa fa-search fs-5"></i></a>
                                </li>
                            </ul>
                        </div>
                        {/* <!-- /.navbar-collapse -->   */}
                        <div className="register-login">
                            <a href="#" className="nir-btn white">Buy Ticket <i className="fa fa-angle-right "></i></a>
                        </div>
