...
export default function Footer() {
  return (
    ...
    {/* <!-- footer starts --> */}
    <footer className="pt-12 pb-7" style={{backgroundImage:" url(images/pexels-sascha.jpg)"}}>
                ...
                <div className="col-lg-3 col-md-6 mb-5">
                    <div className="footer-links">
                        ...
                        <div className="footer-contact d-flex align-items-center mb-3">
                            <i className="fa fa-phone white fs-4"></i>
                        ...
                        <div className="footer-contact d-flex align-items-center">
                            <i className="fa fa-envelope white fs-4"></i>
                            <div className="footer-contact-content ps-3">
        ...
        <div className="theme-overlay opacity-90"></div>
    </footer>
