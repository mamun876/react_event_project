...
<section className="banner pt-10 pb-0 overflow-hidden" style={{backgroundImage: 'url(assets/images/pexels-wendy-wei-1190297.jpg)'}}>
            ...
            <div className="banner-in pt-6">
              <div className="row align-items-end">
                ...
                <div className="col-lg-5">
                  <div className="banner-image" style={{backgroundImage: 'url(images/manbg.png)'}}>
            ...
            <div className="about-image-box">
              <div className="row d-flex align-items-center justify-content-between">
                ...
                <div className="col-lg-7 ps-4">
                  <div className="about-features" style={{backgroundImage: 'url(images/contentbg.png)'}}>
                    <div className="row align-items-center">
          ...
          <div className="container">
            ...
            <div className="schedule-item">
                ...
                <div className="row">
                  <div className="col-lg-3 d-flex">
                    <div className="about-content text-center text-lg-start p-4 py-8 bg-theme w-100">
                      <small className="white mb-2">8:00 Am - 9:00 AM</small>
                      <h4 className="white mb-0">Opening Ceremony</h4>
                    </div>
                  </div>
                  ...
                  <div className="col-lg-3 d-flex">
                    <div className="schedule-speaker d-lg-flex p-4 align-items-center text-center text-lg-start w-100 border-start">
                      <img src="assets/images/reviewer/1.jpg" alt="" className="rounded-circle img-circle" />
              ...
              <div className="about-image-box bg-white mb-4">
                <div className="row">
                  <div className="col-lg-3 d-flex">
                    <div className="about-content text-center text-lg-start p-4 py-8 bg-theme3 w-100">
                      <small className="white mb-2">9:00 Am - 10:00 AM</small>
                      <h4 className="white mb-0">Greetings Event</h4>
                    </div>
                  </div>
                  <div className="col-lg-6 d-flex">
                    <div className="schedule-content text-lg-start text-center py-4">
                      <h4 className="mb-1"> Greetings and Opening Event</h4>
                      <p className="mb-3">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.</p>
                      <ul className="schedule-items d-flex justify-content-lg-start justify-content-center">
                        <li className="d-flex align-items-center me-4">
                          <i className="icon-location-pin theme pe-1" />
                  ...
                  <div className="col-lg-3 d-flex">
                    <div className="schedule-speaker d-lg-flex p-4 align-items-center text-center text-lg-start w-100 border-start">
                      <img src="assets/images/reviewer/2.jpg" alt="" className="rounded-circle img-circle" />
                      <div className="speaker-content ms-3">
                        <h6 className="mb-0 theme">Ricky Malone</h6>
                        <small>Host &amp; Speaker</small>
                      </div>
                    </div>
                  </div>
              ...
              <div className="about-image-box bg-white mb-4">
                <div className="row">
                  <div className="col-lg-3 d-flex">
                    <div className="about-content text-center text-lg-start p-4 py-8 bg-theme w-100">
                      <small className="white mb-2">10:00 Am - 10:30 AM</small>
                      <h4 className="white mb-0">Break And Coffee</h4>
                    </div>
                  </div>
                  <div className="col-lg-6 d-flex">
                    <div className="schedule-content text-lg-start text-center py-4">
                      <h4 className="mb-1"> Tea and Coffee Break</h4>
                      <p className="mb-3">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.</p>
                      <ul className="schedule-items d-flex justify-content-lg-start justify-content-center">
                        <li className="d-flex align-items-center me-4">
                          <i className="icon-location-pin theme pe-1" />
              ...
              <div className="about-image-box bg-white mb-4">
                <div className="row">
                  <div className="col-lg-3 d-flex">
                    <div className="about-content text-center text-lg-start p-4 py-8 bg-theme3 w-100">
                      <small className="white mb-2">10:00 Am - 10:30 AM</small>
                      <h4 className="white mb-0">Digital Workshop</h4>
                    </div>
                  </div>
                  <div className="col-lg-6 d-flex">
                    <div className="schedule-content text-lg-start text-center py-4">
                      <h4 className="mb-1"> Digital Marketing Workshop</h4>
                      <p className="mb-3">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.</p>
                      <ul className="schedule-items d-flex justify-content-lg-start justify-content-center">
                        <li className="d-flex align-items-center me-4">
                          <i className="icon-location-pin theme pe-1" />
                  ...
                  <div className="col-lg-3 d-flex">
                    <div className="schedule-speaker d-lg-flex p-4 align-items-center text-center text-lg-start w-100 border-start">
                      <img src="assets/images/reviewer/3.jpg" alt="" className="rounded-circle img-circle" />
                      <div className="speaker-content ms-3">
                        <h6 className="mb-0 theme">Nelly Bell</h6>
                        <small>Speaker</small>
                      </div>
                    </div>
                  </div>
        ...
        {/* event-schedule ends */}
        {/* our teams starts */}
        <section className="event-team" style={{backgroundImage: 'url(images/manbg.png)'}}>
          <div className="container">
            ...
            <div className="team-main">
              <div className="row align-items-center">
                <div className="col-lg-3 mb-4">
                  <div className="team-list position-relative">
                    <div className="team-image border-all p-2 bg-white">
                      <img src="assets/images/team/img6.jpg" alt="team" />
                    </div>
                ...
                <div className="col-lg-3 mb-4">
                  <div className="team-list position-relative">
                    <div className="team-image border-all p-2 bg-white">
                      <img src="assets/images/team/img5.jpg" alt="team" />
                    </div>
                    <div className="team-content text-center p-4">
                      <h4 className="mb-0 theme">Horke Pels</h4>
                      <p className="mb-3 white">Head Officer</p>
              ...
              <div className="row">
                ...
                <div className="col-lg-4 mb-6">
                  <div className="pricing-item text-center p-5 bg-theme1 position-relative">
                    <div className="pricing-top" style={{backgroundImage: 'url(images/pricebox-topblue.png)'}} />
        ...
        <section className="event-calltoaction pb-0" style={{backgroundImage: 'url(images/pexels-sascha.jpg)'}}>
          <div className="container">
            ...
            <div className="video-expo w-75 mx-auto position-relative mb-minus">
              <img src="assets/images/blog/blog1.jpg" alt="" className="p-2 bg-white" />
        ...
        <section className="event-gallery pb-0 pt-18" style={{backgroundImage: 'url(images/speaker_bg.png)'}}>
          <div className="container">
            <div className="section-title mb-5 w-75 mx-auto text-center">
            ...
            <div className="event-gallerystart mb-minus">
              <div className="row gallery-main">
                <div className="col-lg-4 col-md-6 mansonry-item p-2">
                  <div className="gallery-item">
                    <div className="gallery-image">
                      <a href="images/blog/blog1.jpg" data-lightbox="gallery" data-title="Title">
                ...
                <div className="col-lg-4 col-md-6 mansonry-item p-2">
                  <div className="gallery-item">
                    <div className="gallery-image">
                      <a href="images/blog/blog2.jpg" data-lightbox="gallery" data-title="Title">
                ...
                <div className="col-lg-4 col-md-6 mansonry-item p-2">
                  <div className="gallery-item">
                    <div className="gallery-image">
                      <a href="images/blog/blog3.jpg" data-lightbox="gallery" data-title="Title">
                ...
                <div className="col-lg-4 col-md-6 mansonry-item p-2">
                  <div className="gallery-item">
                    <div className="gallery-image">
                      <a href="images/blog/blog4.jpg" data-lightbox="gallery" data-title="Title">
            ...
            <div className="row">
              <div className="col-lg-8 col-lg-offset-4">
                <div className="section-title text-center text-lg-start">
                  ...
                  <div className="selector4" style={{display: 'flex', justifyContent: 'center'}}>
                    <h2 className="ah-headline mb-0">
                      <span>What Peopless Says About</span>
                      <span className="ah-words-wrapper white theme">
            ...
            <div className="row align-items-center">
                    ...
                    <div className="testimonial-item bg-white p-5">
                      <div className="testi-details mb-4">
                        ...
                        <p className="m-0">Lorem Ipsum is simply dummy
                          ...
                          has been the industrys standard dummy hic et quidem. Dignissimos maxime velit
              ...
              <div className="col-lg-5 ps-lg-5">
                <div className="testimonial-image">
                  <img src="assets/images/testi-image.png" alt="" className="opacity-50" />
                </div>
              </div>
            </div>
          </div>
        ...
        {/* testimonial ends */}
        {/* partner starts */}
        <section className="event-partners pb-8" style={{backgroundImage: 'url(images/contentbg.png)'}}>
          <div className="container">
            <div className="section-title mb-5 w-75 mx-auto text-center">
