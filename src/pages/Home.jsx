...
export default function Home() {
  ...
  const getProduct = () => {
    axios
      .get("http://localhost:8080/productsall")
  ...
  return (
            ...
            <div className="row align-items-end">
              ...
              <div className="col-lg-5">
                <div
                  ...
                  style={{ backgroundImage: "url(images/manbg.png)" }}
                >
        ...
        <div className="container">
          <div className="row">
            <div className="col-lg-7 col-lg-offset-5">
              <div
                className="coming-counter d-md-flex align-items-center justify-content-between p-4 py-5 text-md-start text-center"
                data-date="2023-12-28 00:00:00"
              >
            ...
            <div className="row d-flex align-items-center justify-content-between">
              <div className="col-lg-7 pe-lg-4">
                <div
                  ...
                  style={{
                    backgroundImage: "url(assets/images/contentbg.png)",
                  }}
                >
              ...
              <div className="col-lg-5 ps-lg-4">
                <div className="about-content text-center text-lg-start mb-4">
                  ...
                  <p className="mb-4">
                    ...
                    aliqua. Quis ip suspendisse ultrices gravida. Risus commodo
                  </p>
              ...
              <div className="col-lg-5 pe-4">
                <div className="about-content section-title text-lg-start text-center mb-4">
                  ...
                  <a href="about.html" className="nir-btn">
                    Discover Now <i className="fa fa-angle-right " />
                  </a>
                </div>
              </div>
        ...
        <div className="container">
          ...
          <div className="team-main">
            ...
            <div className="speaker-btn text-center">
              <a href="speaker-detail.html" className="nir-btn">
                View All Speakers <i className="fa fa-angle-right " />
              </a>
            </div>
          </div>
        </div>
          ...
          <div className="row">
            <div className="col-lg-8 col-lg-offset-4">
              <div className="section-title text-lg-start text-center mb-5">
                ...
                <h4 className="theme">Pricing Table</h4>
                <div
                  className="selector4"
                  style={{ display: "flex", justifyContent: "center" }}
                >
    ...
    <div className="col-lg-4 mb-6" key={index}>
            ...
            <div className="pricing-top">
                ...
                <div className="pricing-price py-4">
                    <h2 className="mb-0 theme d-flex align-items-start justify-content-center lh-1">
                        <span className="pricing-currency theme">$</span> 39.
                        <span className="fs-5">99</span>
                    </h2>
                    <p className="mb-0">Person</p>
                </div>
                <ul className="pricing-features-list mb-4">
                    <li className="d-block border-b pb-2 mb-2">
                        Second Balcony Seat
                    </li>
                    <li className="d-block border-b pb-2 mb-2">
                        Snack &amp; Softdrink
                ...
                <small>*Please read our terms and conditions before ordering tickets</small>
            </div>
        </div>
    </div>
))}
      ...
      <section
        className="event-calltoaction pb-0"
        style={{ backgroundImage: "url(images/pexels-sascha.jpg)" }}
      >
        <div className="container">
          ...
          <div className="event-expo w-60 mx-auto mb-7">
            <div
              className="event-expo-item mb-4"
      ...
      <section
        className="event-gallery pb-0 pt-18"
        style={{ backgroundImage: "url(images/speaker_bg.png)" }}
      >
        <div className="container">
          <div className="section-title mb-5 w-75 mx-auto text-center">
          ...
          <div className="row align-items-center">
            ...
            <div className="col-lg-5 ps-lg-5">
              <div className="testimonial-image">
                <img
                  src="assets/images/testi-image.png"
                  alt=""
                ...
                <div className="articles-item border-all bg-white overflow-hidden position-relative">
                  ...
                  <div className="articles-content-main">
                    ...
                    <ul className="border-top d-block w-100 p-4 py-2">
                      <li>August 25, 2022</li> |<li> No Comments</li>
                    </ul>
                  </div>
                </div>
              </div>
                ...
                <div className="articles-item border-all bg-white overflow-hidden position-relative">
                  ...
                  <div className="articles-content-main">
                    <div className="articles-content p-4 pb-2">
                      <h4>
                        <a href="detail-1.html">
                          Runner with Autism Graces of Women
                        </a>
                      </h4>
                      <a href="#" className="theme textupper small">
                        Continue Reading
                ...
                <div className="articles-item border-all bg-white overflow-hidden position-relative">
                  ...
                  <div className="articles-content-main">
                    <div className="articles-content p-4 pb-2">
                      <h4>
                        <a href="detail-1.html">
                          Services To Grow Your Business Sell Affiliate
                        </a>
                      </h4>
                      <a href="#" className="theme textupper small">
                        Continue Reading
